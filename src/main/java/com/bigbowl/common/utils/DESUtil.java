...
public class DESUtil {
	...
	/** 字符串默认键值 */
	private static String strDefaultKey = "bybonDES";

	/** 加密工具 */
	private Cipher encryptCipher = Cipher.getInstance("DES");

	/** 解密工具 */
	private Cipher decryptCipher = Cipher.getInstance("DES");
